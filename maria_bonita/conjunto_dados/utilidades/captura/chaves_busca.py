...
MISOGINIA = Chave_Busca(
  ...
  adjetivos_singular=['puta', 'putinha', 'prostituta', 'piranha', 'biscate', 'vaca', 'vaquinha', 'pistoleira',
                      ...
                      'louca', 'louquinha', 'loucona', 'maluca', 'maluquinha', 'malucona', 'desequilibrada', 'perturbada', 'histérica', 'surtada',
  ...
  adjetivos_singular_erro=['biscati', 'biskate', 'biskati', 'vaka', 'vakinha', 'pistolera',
                           ...
                           'maluka', 'malukinha', 'malukona', 'histerica',
                           'mau comida', 'malcomida', 'maucomida', 'mau amada'],
  adjetivos_plural=['putas', 'putinhas', 'prostitutas', 'piranhas', 'biscates', 'vacas', 'vaquinhas', 'pistoleiras',
                    ...
                    'loucas', 'louquinhas', 'malucas', 'maluquinhas', 'maluconas', 'desequilibradas', 'perturbadas', 'histéricas', 'surtadas'
  ...
  adjetivos_plural_erro=['biscatis', 'biskates', 'biskatis', 'vakas', 'vakinhas', 'pistoleras',
                         ...
                         'malukas', 'malukinhas', 'malukonas', 'histericas',
                         'mau comidas', 'malcomidas', 'maucomidas', 'mau amadas'],
  substantivos_singular=['feminismo', 'estupro', 'surto'],
  substantivos_singular_erro=['estrupo'],
  substantivos_plural=['estupros', 'surtos'],
  substantivos_plural_erro=['estrupos'],
